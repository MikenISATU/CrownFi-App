...
export function TestnetFundingPanel({ compact = false, className = "" }: TestnetFundingPanelProps) {
  ...
  return (
    <section
      ...
      className={`overflow-hidden rounded-2xl border border-[#d4af37]/55 bg-[radial-gradient(circle_at_4%_0%,rgba(0,82,255,0.42),transparent_38%),linear-gradient(115deg,#061044_0%,#0b1b71_52%,#090c28_100%)] text-white shadow-[0_24px_55px_-36px_rgba(0,43,180,0.9)] ${className}`}
    >
        ...
        <div className="grid border-t border-white/10 sm:grid-cols-2 lg:border-l lg:border-t-0">
          <div className={`${compact ? "p-5 sm:p-6" : "p-6 sm:p-8"} border-b border-white/10 sm:border-b-0 sm:border-r`}>
            <div className="flex items-center gap-3">
              <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-[#0052ff] ring-1 ring-white/20">
