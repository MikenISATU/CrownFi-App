...
import { Vote, ShieldCheck, Ticket, Gem, User, Crown, Lock, Menu, ChevronLeft, ChevronRight, ChevronDown, Wallet, Mail, Check, X, RefreshCw, Sun, Moon, Search } from "lucide-react";
