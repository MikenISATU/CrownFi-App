export function TestnetNotice({ compact = false }: { compact?: boolean }) {
  return (
    <div className={`overflow-hidden rounded-2xl border-2 border-[#f2d784] bg-[#061333] text-white shadow-[0_20px_50px_-34px_rgba(6,19,51,0.9)] ${compact ? "px-4 py-3" : "px-5 py-4 sm:px-6"}`} role="note" aria-label="Free testnet notice">
