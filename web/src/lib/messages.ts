...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  market_database_unavailable: "The market database is not ready. No wallet transaction was sent; please try again shortly.",
  market_preflight_failed: "CrownFi could not verify market creation readiness. No wallet transaction was sent.",
  transaction_wallet_unavailable: "Reconnect the same Base wallet before submitting this transaction.",
